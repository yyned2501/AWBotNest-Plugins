              ...
              : (group.value === 'horse')
                ...
                : (group.value === 'zjh')
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                      _cache[118] || (_cache[118] = _createElementVNode("h3", { class: "det-title" }, "炸金花", -1)),
                      ...
                      _cache[119] || (_cache[119] = _createElementVNode("section", { class: "card" }, [
                      ...
                      _createElementVNode("section", _hoisted_51, [
                        _cache[97] || (_cache[97] = _createElementVNode("div", { class: "card-h" }, "进攻策略（可选）", -1)),
                        _cache[98] || (_cache[98] = _createElementVNode("span", { class: "help" }, " 所有阈值均基于最终实际胜率：蒙牌对手按单挑胜率相乘；已看牌对手按其实际下注反推的最低牌力条件化后相乘。 开牌和追加只会在门户 actions 明确允许时发送；默认关闭，建议先观察日志中的服务端成本。 ", -1)),
                        _createElementVNode("div", _hoisted_52, [
                          ...
                          _createElementVNode("div", _hoisted_56, [
                            _createElementVNode("label", _hoisted_57, [
                              ...
                              _cache[94] || (_cache[94] = _createElementVNode("span", null, "启用高胜率主动追加", -1))
                            ]),
                            _cache[96] || (_cache[96] = _createElementVNode("span", { class: "help" }, "正 EV 且最终实际胜率达到阈值时，若允许 raise 则追加。", -1)),
                            ...
                            (cfg.zjh_raise_enabled)
                              ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                  ...
                                  _cache[95] || (_cache[95] = _createElementVNode("span", { class: "help" }, "达阈值时按此概率加注、其余慢打平跟做伪装；100=达标必加。", -1))
                                ], 64))
                      ...
                      _createElementVNode("section", _hoisted_60, [
                        _cache[100] || (_cache[100] = _createElementVNode("div", { class: "card-h" }, "看牌对手推断", -1)),
                        _createElementVNode("div", _hoisted_61, [
                          _createElementVNode("span", _hoisted_62, "未观测到下注时的牌力阈值：" + _toDisplayString(cfg.zjh_peeked_threshold) + "%", 1),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[28] || (_cache[28] = $event => ((cfg.zjh_peeked_threshold) = $event)),
                            type: "range",
                            min: "0",
                            max: "95",
                            step: "5"
                          ...
                          _cache[99] || (_cache[99] = _createElementVNode("span", { class: "help" }, " 系统优先按对手看牌后实际下注时的底池和成本反推门槛；轮询漏掉该动作时才使用此回退值。 ", -1))
                        ])
                      ]),
                      _createElementVNode("section", _hoisted_63, [
                        _cache[105] || (_cache[105] = _createElementVNode("div", { class: "card-h" }, "范围上限与反诈唬（放松跟注）", -1)),
                        _cache[106] || (_cache[106] = _createElementVNode("span", { class: "help" }, " 看牌后评估胜率时，对手手牌不再默认可能是直到最强的任意牌：平跟/仅看牌对手按[推断门槛, 牌力上限]、 加注对手按[牌力下限, 100%]估计；反诈唬基线把每个已看牌对手有固定比例视为纯空气牌。整体更敢跟、少弃牌。 牌力上限设 100% 且反诈唬设 0% 即精确回到旧行为。 ", -1)),
                        _createElementVNode("div", _hoisted_64, [
                          _createElementVNode("span", _hoisted_65, "平跟对手牌力上限：" + _toDisplayString(cfg.zjh_call_range_cap) + "%", 1),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[29] || (_cache[29] = $event => ((cfg.zjh_call_range_cap) = $event)),
                            type: "range",
                            min: "50",
                            max: "100",
                            step: "5"
                          ...
                          _cache[101] || (_cache[101] = _createElementVNode("span", { class: "help" }, "只平跟/看牌不追加的对手，牌力按[推断门槛, 此上限]估计。100% = 旧行为。", -1))
                        ]),
                        _createElementVNode("div", _hoisted_66, [
                          _createElementVNode("span", _hoisted_67, "加注对手牌力下限：" + _toDisplayString(cfg.zjh_raise_range_floor) + "%", 1),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[30] || (_cache[30] = $event => ((cfg.zjh_raise_range_floor) = $event)),
                            type: "range",
                            min: "50",
                            max: "100",
                            step: "5"
                          ...
                          _cache[102] || (_cache[102] = _createElementVNode("span", { class: "help" }, "追加过的对手按[max(推断门槛, 此下限), 100%]估计；低于推断门槛时以推断门槛为准。", -1))
                        ]),
                        _createElementVNode("div", _hoisted_68, [
                          _createElementVNode("span", _hoisted_69, "反诈唬基线：" + _toDisplayString(cfg.zjh_bluff_rate) + "%", 1),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[31] || (_cache[31] = $event => ((cfg.zjh_bluff_rate) = $event)),
                            type: "range",
                            min: "0",
                            max: "30",
                            step: "1"
                          ...
                          _cache[103] || (_cache[103] = _createElementVNode("span", { class: "help" }, "每个已看牌对手有该比例概率是纯空气牌（诈唬），抬高我方胜率。0% = 关闭。", -1))
                        ]),
                        _createElementVNode("div", _hoisted_70, [
                          _createElementVNode("span", _hoisted_71, "弃牌 EV 容差：" + _toDisplayString(cfg.zjh_fold_ev_tolerance) + "% callBet", 1),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[32] || (_cache[32] = $event => ((cfg.zjh_fold_ev_tolerance) = $event)),
                            type: "range",
                            min: "0",
                            max: "30",
                            step: "1"
                      ...
                      _createElementVNode("section", _hoisted_72, [
                        _cache[110] || (_cache[110] = _createElementVNode("div", { class: "card-h" }, "蒙牌决策（终局 EV 决策树）", -1)),
                        _cache[111] || (_cache[111] = _createElementVNode("span", { class: "help" }, " 蒙牌不再只看当前一步的期望收益，而是推演未来几轮：对手每轮跟/加/弃（概率来自对手画像）， 我方蒙牌胜率随对手连续加注衰减（门槛贝叶斯上调），求到达摊牌/弃牌的终局期望。 连续盲跟过多会被强制看牌止损，避免像单步 EV 那样闭眼跟到强制摊牌巨亏。 ", -1)),
                        _createElementVNode("div", _hoisted_73, [
                          ...
                          _cache[107] || (_cache[107] = _createElementVNode("span", { class: "help" }, "推演未来 N 轮对手动作再算终局 EV。1 = 退回旧单步 EV 行为。", -1))
                        ]),
                        _createElementVNode("div", _hoisted_75, [
                          ...
                          _cache[108] || (_cache[108] = _createElementVNode("span", { class: "help" }, "蒙牌连续盲跟达该轮数后强制看牌止损。0 = 不限，纯按终局 EV。", -1))
                        ]),
                        _createElementVNode("label", _hoisted_77, [
                          ...
                          _cache[109] || (_cache[109] = _createElementVNode("span", null, "启用对手画像", -1))
                        ]),
                        _cache[112] || (_cache[112] = _createElementVNode("span", { class: "help" }, "按玩家 ID 跨局统计每个对手在各状态下的跟/加/弃频率，供决策树预测动作。未知对手用全局先验。", -1))
                      ]),
                      _createElementVNode("section", _hoisted_78, [
                        _cache[117] || (_cache[117] = _createElementVNode("div", { class: "card-h" }, "通知", -1)),
                        _createElementVNode("label", _hoisted_79, [
                          ...
                          _cache[113] || (_cache[113] = _createElementVNode("span", null, "加入牌局", -1))
                        ]),
                        _createElementVNode("label", _hoisted_80, [
                          ...
                          _cache[114] || (_cache[114] = _createElementVNode("span", null, "手牌决策（跟注/弃牌）", -1))
                        ]),
                        _createElementVNode("label", _hoisted_81, [
                          ...
                          _cache[115] || (_cache[115] = _createElementVNode("span", null, "双击确认弃牌", -1))
                        ]),
                        _createElementVNode("label", _hoisted_82, [
                          ...
                          _cache[116] || (_cache[116] = _createElementVNode("span", null, "异常", -1))
                        ])
                      ]),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-dee61eba"]]);
