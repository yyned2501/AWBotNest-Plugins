...
const _hoisted_80 = { class: "savebar" };
              ...
              : (group.value === 'horse')
                ...
                : (group.value === 'zjh')
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                      _cache[114] || (_cache[114] = _createElementVNode("h3", { class: "det-title" }, "炸金花", -1)),
                      ...
                      _cache[115] || (_cache[115] = _createElementVNode("section", { class: "card" }, [
                      ...
                      _createElementVNode("section", _hoisted_51, [
                        _cache[94] || (_cache[94] = _createElementVNode("div", { class: "card-h" }, "进攻策略（可选）", -1)),
                        _cache[95] || (_cache[95] = _createElementVNode("span", { class: "help" }, " 所有阈值均基于最终实际胜率：蒙牌对手按单挑胜率相乘；已看牌对手按其实际下注反推的最低牌力条件化后相乘。 开牌和追加只会在门户 actions 明确允许时发送；默认关闭，建议先观察日志中的服务端成本。 ", -1)),
                        _createElementVNode("div", _hoisted_52, [
                          ...
                          _createElementVNode("div", _hoisted_56, [
                            ...
                            _cache[93] || (_cache[93] = _createElementVNode("span", { class: "help" }, "正 EV 且最终实际胜率达到阈值时，若允许 raise 则追加。", -1)),
                      ...
                      _createElementVNode("section", _hoisted_59, [
                        _cache[97] || (_cache[97] = _createElementVNode("div", { class: "card-h" }, "看牌对手推断", -1)),
                        _createElementVNode("div", _hoisted_60, [
                          ...
                          _cache[96] || (_cache[96] = _createElementVNode("span", { class: "help" }, " 系统优先按对手看牌后实际下注时的底池和成本反推门槛；轮询漏掉该动作时才使用此回退值。 ", -1))
                        ])
                      ]),
                      _createElementVNode("section", _hoisted_62, [
                        _cache[101] || (_cache[101] = _createElementVNode("div", { class: "card-h" }, "范围上限与反诈唬（放松跟注）", -1)),
                        _cache[102] || (_cache[102] = _createElementVNode("span", { class: "help" }, " 看牌后评估胜率时，对手手牌不再默认可能是直到最强的任意牌：平跟/仅看牌对手按[推断门槛, 牌力上限]、 加注对手按[牌力下限, 100%]估计；反诈唬基线把每个已看牌对手有固定比例视为纯空气牌。整体更敢跟、少弃牌。 牌力上限设 100% 且反诈唬设 0% 即精确回到旧行为。 ", -1)),
                        _createElementVNode("div", _hoisted_63, [
                          ...
                          _cache[98] || (_cache[98] = _createElementVNode("span", { class: "help" }, "只平跟/看牌不追加的对手，牌力按[推断门槛, 此上限]估计。100% = 旧行为。", -1))
                        ]),
                        _createElementVNode("div", _hoisted_65, [
                          ...
                          _cache[99] || (_cache[99] = _createElementVNode("span", { class: "help" }, "追加过的对手按[max(推断门槛, 此下限), 100%]估计；低于推断门槛时以推断门槛为准。", -1))
                        ]),
                        _createElementVNode("div", _hoisted_67, [
                          ...
                          _cache[100] || (_cache[100] = _createElementVNode("span", { class: "help" }, "每个已看牌对手有该比例概率是纯空气牌（诈唬），抬高我方胜率。0% = 关闭。", -1))
                        ])
                      ]),
                      _createElementVNode("section", _hoisted_69, [
                        _cache[106] || (_cache[106] = _createElementVNode("div", { class: "card-h" }, "蒙牌决策（终局 EV 决策树）", -1)),
                        _cache[107] || (_cache[107] = _createElementVNode("span", { class: "help" }, " 蒙牌不再只看当前一步的期望收益，而是推演未来几轮：对手每轮跟/加/弃（概率来自对手画像）， 我方蒙牌胜率随对手连续加注衰减（门槛贝叶斯上调），求到达摊牌/弃牌的终局期望。 连续盲跟过多会被强制看牌止损，避免像单步 EV 那样闭眼跟到强制摊牌巨亏。 ", -1)),
                        _createElementVNode("div", _hoisted_70, [
                          _createElementVNode("span", _hoisted_71, "决策树深度：" + _toDisplayString(cfg.zjh_terminal_depth) + " 轮", 1),
                          _withDirectives(_createElementVNode("input", {
                          ...
                          _cache[103] || (_cache[103] = _createElementVNode("span", { class: "help" }, "推演未来 N 轮对手动作再算终局 EV。1 = 退回旧单步 EV 行为。", -1))
                        ]),
                        _createElementVNode("div", _hoisted_72, [
                          _createElementVNode("span", _hoisted_73, "连续盲跟上限：" + _toDisplayString(cfg.zjh_blind_max_calls) + " 轮", 1),
                          _withDirectives(_createElementVNode("input", {
                          ...
                          _cache[104] || (_cache[104] = _createElementVNode("span", { class: "help" }, "蒙牌连续盲跟达该轮数后强制看牌止损。0 = 不限，纯按终局 EV。", -1))
                        ]),
                        _createElementVNode("label", _hoisted_74, [
                          ...
                          _cache[105] || (_cache[105] = _createElementVNode("span", null, "启用对手画像", -1))
                        ]),
                        _cache[108] || (_cache[108] = _createElementVNode("span", { class: "help" }, "按玩家 ID 跨局统计每个对手在各状态下的跟/加/弃频率，供决策树预测动作。未知对手用全局先验。", -1))
                      ]),
                      _createElementVNode("section", _hoisted_75, [
                        _cache[113] || (_cache[113] = _createElementVNode("div", { class: "card-h" }, "通知", -1)),
                        _createElementVNode("label", _hoisted_76, [
                          ...
                          _cache[109] || (_cache[109] = _createElementVNode("span", null, "加入牌局", -1))
                        ]),
                        _createElementVNode("label", _hoisted_77, [
                          ...
                          _cache[110] || (_cache[110] = _createElementVNode("span", null, "手牌决策（跟注/弃牌）", -1))
                        ]),
                        _createElementVNode("label", _hoisted_78, [
                          ...
                          _cache[111] || (_cache[111] = _createElementVNode("span", null, "双击确认弃牌", -1))
                        ]),
                        _createElementVNode("label", _hoisted_79, [
                          ...
                          _cache[112] || (_cache[112] = _createElementVNode("span", null, "异常", -1))
                        ])
                      ]),
                      _createElementVNode("div", _hoisted_80, [
                        _createElementVNode("button", {
                          ...
                          disabled: saving.value,
                          onClick: save
                        }, _toDisplayString(saving.value ? '保存中…' : '保存配置'), 9, _hoisted_81)
                      ])
                    ], 64))
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-cb570840"]]);
