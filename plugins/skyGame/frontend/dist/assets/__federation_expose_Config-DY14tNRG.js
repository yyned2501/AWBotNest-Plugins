...
const _hoisted_14 = { class: "savebar" };
...
const _hoisted_38 = { class: "hand-grid" };
    ...
    (loading.value)
      ...
      : (_openBlock(), _createElementBlock("div", _hoisted_3, [
          _createElementVNode("aside", _hoisted_4, [
            _cache[18] || (_cache[18] = _createElementVNode("div", { class: "side-title" }, "游戏", -1)),
          ...
          _createElementVNode("div", _hoisted_7, [
            (group.value === 'global')
              ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                  _cache[28] || (_cache[28] = _createElementVNode("h3", { class: "det-title" }, "全局设置", -1)),
                  _createElementVNode("section", _hoisted_8, [
                    _cache[23] || (_cache[23] = _createElementVNode("div", { class: "card-h" }, "目标与机器人", -1)),
                    _createElementVNode("div", _hoisted_9, [
                      _cache[19] || (_cache[19] = _createElementVNode("span", { class: "lbl" }, "目标群组（一行一个ID）", -1)),
                      ...
                      _cache[20] || (_cache[20] = _createElementVNode("span", { class: "help" }, "游戏消息发到的群，一行一个。", -1))
                    ]),
                    _createElementVNode("div", _hoisted_10, [
                      _cache[21] || (_cache[21] = _createElementVNode("span", { class: "lbl" }, "天空小秘机器人", -1)),
                      ...
                      _cache[22] || (_cache[22] = _createElementVNode("span", { class: "help" }, "留空=默认天空小秘。", -1))
                    ])
                  ]),
                  _createElementVNode("section", _hoisted_11, [
                    _cache[27] || (_cache[27] = _createElementVNode("div", { class: "card-h" }, "HDSky 门户（炸金花/养马共用）", -1)),
                    _createElementVNode("div", _hoisted_12, [
                      _cache[24] || (_cache[24] = _createElementVNode("span", { class: "lbl" }, "Cookie 文件路径", -1)),
                      _withDirectives(_createElementVNode("input", {
                      ...
                      _cache[25] || (_cache[25] = _createElementVNode("span", { class: "help" }, "容器内路径（宿主 appdata/awbotnest/data 目录），12 小时过期需重新覆盖", -1))
                    ]),
                    _createElementVNode("div", _hoisted_13, [
                      _cache[26] || (_cache[26] = _createElementVNode("span", { class: "lbl" }, "门户地址", -1)),
                      _withDirectives(_createElementVNode("input", {
              ...
              : (group.value === 'horse')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                    _cache[47] || (_cache[47] = _createElementVNode("h3", { class: "det-title" }, "养马", -1)),
                    _createElementVNode("section", _hoisted_16, [
                      _cache[34] || (_cache[34] = _createElementVNode("div", { class: "card-h" }, "基础设置", -1)),
                      _createElementVNode("label", _hoisted_17, [
                        _withDirectives(_createElementVNode("input", {
                          "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((cfg.horse_enabled) = $event)),
                          type: "checkbox"
                        }, null, 512), [
                          [_vModelCheckbox, cfg.horse_enabled]
                        ]),
                        _cache[29] || (_cache[29] = _createElementVNode("span", null, "启用养马自动化", -1))
                      ]),
                      ...
                      _createElementVNode("div", _hoisted_18, [
                        _createElementVNode("div", _hoisted_19, [
                          _cache[30] || (_cache[30] = _createElementVNode("span", { class: "lbl" }, "养护轮询间隔(秒)", -1)),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((cfg.horse_poll_interval) = $event)),
                            class: "inp",
                            type: "number",
                            min: "30",
                            max: "600",
                          ...
                          _cache[31] || (_cache[31] = _createElementVNode("span", { class: "help" }, "节奏拟人，不用太频繁", -1))
                        ]),
                        _createElementVNode("div", _hoisted_20, [
                          _cache[33] || (_cache[33] = _createElementVNode("span", { class: "lbl" }, "养马通知", -1)),
                          _createElementVNode("label", _hoisted_21, [
                            _withDirectives(_createElementVNode("input", {
                              "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((cfg.horse_notify) = $event)),
                              type: "checkbox"
                            }, null, 512), [
                              [_vModelCheckbox, cfg.horse_notify]
                            ]),
                            _cache[32] || (_cache[32] = _createElementVNode("span", null, "操作结果推送", -1))
                          ])
                        ])
                      ])
                    ]),
                    _createElementVNode("section", _hoisted_22, [
                      _cache[39] || (_cache[39] = _createElementVNode("div", { class: "card-h" }, "自动喂食", -1)),
                      _createElementVNode("div", _hoisted_23, [
                        _createElementVNode("div", _hoisted_24, [
                          _cache[36] || (_cache[36] = _createElementVNode("span", { class: "lbl" }, "草料", -1)),
                          _withDirectives(_createElementVNode("select", {
                            "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((cfg.horse_feed_type) = $event)),
                            class: "inp"
                          }, [
                            (_openBlock(), _createElementBlock(_Fragment, null, _renderList(FEED_TYPES, (f) => {
                              return _createElementVNode("option", {
                                key: f.value,
                                value: f.value
                              }, _toDisplayString(f.label), 9, _hoisted_25)
                            }), 64))
                          ], 512), [
                        ...
                        _createElementVNode("div", _hoisted_26, [
                          _cache[37] || (_cache[37] = _createElementVNode("span", { class: "lbl" }, "饱腹度阈值", -1)),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((cfg.horse_feed_threshold) = $event)),
                            class: "inp",
                            type: "number",
                            min: "0",
                            max: "100",
                          ...
                          _cache[38] || (_cache[38] = _createElementVNode("span", { class: "help" }, "低于此值且今日次数未用完时喂（每日上限 5 次）", -1))
                        ])
                      ])
                    ]),
                    _createElementVNode("section", _hoisted_27, [
                      _cache[43] || (_cache[43] = _createElementVNode("div", { class: "card-h" }, "自动行为", -1)),
                      _createElementVNode("label", _hoisted_28, [
                        _withDirectives(_createElementVNode("input", {
                          "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((cfg.horse_auto_walk) = $event)),
                          type: "checkbox"
                        }, null, 512), [
                          [_vModelCheckbox, cfg.horse_auto_walk]
                        ]),
                        _cache[40] || (_cache[40] = _createElementVNode("span", null, "自动遛马", -1))
                      ]),
                      ...
                      _createElementVNode("label", _hoisted_29, [
                        _withDirectives(_createElementVNode("input", {
                          "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((cfg.horse_auto_official_race) = $event)),
                          type: "checkbox"
                        }, null, 512), [
                          [_vModelCheckbox, cfg.horse_auto_official_race]
                        ]),
                        _cache[41] || (_cache[41] = _createElementVNode("span", null, "自动报名官方赛", -1))
                      ]),
                      ...
                      _createElementVNode("label", _hoisted_30, [
                        _withDirectives(_createElementVNode("input", {
                          "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((cfg.horse_auto_revive) = $event)),
                          type: "checkbox"
                        }, null, 512), [
                          [_vModelCheckbox, cfg.horse_auto_revive]
                        ]),
                        _cache[42] || (_cache[42] = _createElementVNode("span", null, "死亡自动复活", -1))
                      ]),
                ...
                : (group.value === 'zjh')
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                      _cache[61] || (_cache[61] = _createElementVNode("h3", { class: "det-title" }, "炸金花", -1)),
                      _createElementVNode("section", _hoisted_33, [
                        _cache[51] || (_cache[51] = _createElementVNode("div", { class: "card-h" }, "基础设置", -1)),
                        _createElementVNode("label", _hoisted_34, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((cfg.zjh_enabled) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.zjh_enabled]
                          ]),
                          _cache[48] || (_cache[48] = _createElementVNode("span", null, "启用自动参与", -1))
                        ]),
                        ...
                        _createElementVNode("div", _hoisted_35, [
                          _cache[49] || (_cache[49] = _createElementVNode("span", { class: "lbl" }, "轮询间隔(秒)", -1)),
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((cfg.zjh_poll_interval) = $event)),
                            class: "inp",
                            type: "number",
                            min: "1",
                            max: "10",
                          ...
                          _cache[50] || (_cache[50] = _createElementVNode("span", { class: "help" }, "Cookie 与门户地址见「全局设置」", -1))
                        ])
                      ]),
                      _createElementVNode("section", _hoisted_36, [
                        _cache[55] || (_cache[55] = _createElementVNode("div", { class: "card-h" }, "跟注牌型", -1)),
                        _createElementVNode("div", _hoisted_37, [
                          _cache[53] || (_cache[53] = _createElementVNode("span", { class: "lbl" }, "勾选的牌型跟注，未勾选的弃牌", -1)),
                          ...
                          _cache[54] || (_cache[54] = _createElementVNode("span", { class: "help" }, "全不选时回退默认五种好牌（豹子/同花顺/金花/顺子/对子）", -1))
                        ])
                      ]),
                      _createElementVNode("section", _hoisted_40, [
                        _cache[60] || (_cache[60] = _createElementVNode("div", { class: "card-h" }, "通知", -1)),
                        _createElementVNode("label", _hoisted_41, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((cfg.zjh_notify_join) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.zjh_notify_join]
                          ]),
                          _cache[56] || (_cache[56] = _createElementVNode("span", null, "加入牌局", -1))
                        ]),
                        _createElementVNode("label", _hoisted_42, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((cfg.zjh_notify_hand) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.zjh_notify_hand]
                          ]),
                          _cache[57] || (_cache[57] = _createElementVNode("span", null, "手牌决策（跟注/弃牌）", -1))
                        ]),
                        _createElementVNode("label", _hoisted_43, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((cfg.zjh_notify_fold_confirm) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.zjh_notify_fold_confirm]
                          ]),
                          _cache[58] || (_cache[58] = _createElementVNode("span", null, "双击确认弃牌", -1))
                        ]),
                        _createElementVNode("label", _hoisted_44, [
                          _withDirectives(_createElementVNode("input", {
                            "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((cfg.zjh_notify_error) = $event)),
                            type: "checkbox"
                          }, null, 512), [
                            [_vModelCheckbox, cfg.zjh_notify_error]
                          ]),
                          _cache[59] || (_cache[59] = _createElementVNode("span", null, "异常", -1))
                        ])
                      ]),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-93a62c20"]]);
